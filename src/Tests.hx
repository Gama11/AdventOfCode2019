...
class Tests implements ITest {
	...
	function testDay02() {
		...
		Assert.equals(3500, run("1,9,10,3,2,3,11,0,99,30,40,50"));
		Assert.equals(2, run("1,0,0,0,99"));
		Assert.equals(30, run("1,1,1,4,99,5,6,0,99"));

		Assert.equals(5098658, Day02.runGravityAssistProgram(getData("day02")));
		Assert.equals(5064, Day02.findInputForOutput(getData("day02"), 19690720));
	}
